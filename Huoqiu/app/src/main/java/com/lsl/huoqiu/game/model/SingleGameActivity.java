...
import com.lsl.huoqiu.game.MainView;
...
public class SingleGameActivity extends AppCompatActivity{
    ...
    protected final static String TAG = "GameDemoActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = new SingleView(getBaseContext());//获取到MainView
...
//        loadYMAds();
    ...
    private void save() {
        ...
        SingleTile[][] field = view.game.grid.field;
        SingleTile[][] undoField = view.game.grid.undoField;
    ...
    private void load() {
        ...
        for (int xx = 0; xx < view.game.grid.field.length; xx++) {
            for (int yy = 0; yy < view.game.grid.field[0].length; yy++) {
                ...
                if (value > 0) {
                    view.game.grid.field[xx][yy] = new SingleTile(xx, yy, value);
                } else if (value == 0) {
                ...
                if (undoValue > 0) {
                    view.game.grid.undoField[xx][yy] = new SingleTile(xx, yy, undoValue);
                } else if (value == 0) {
