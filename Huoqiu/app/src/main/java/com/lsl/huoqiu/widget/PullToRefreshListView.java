...
public class PullToRefreshListView extends ListView implements OnScrollListener {  
    ...
    private void init(Context context, AttributeSet attrs) {   
        ...
        TypedArray typedArray = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.PullToRefreshListView, 0, 0);
        boolean isShowHeader = typedArray.getBoolean(R.styleable.PullToRefreshListView_is_show_header, true);
        if(isShowHeader){
...
//                    int topPadding = (int)((tempY - startY - headContentHeight))/8;
//                	if(topPadding>headContentHeight){
//                		topPadding = headContentHeight+(topPadding - headContentHeight);
//                	}
//                	headView.setPadding(headView.getPaddingLeft(), topPadding, headView.getPaddingRight(), headView.getPaddingBottom());    
//                    headView.invalidate(); 
                }  
