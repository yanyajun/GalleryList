...
public class SingleView  extends View{
    ...
    private void drawCells(Canvas canvas) {
        ...
        for (int xx = 0; xx < game.numSquaresX; xx++) {
            for (int yy = 0; yy < game.numSquaresY; yy++) {
                ...
                SingleTile currentTile = game.grid.getCellContent(xx, yy);
                if (currentTile != null) {
                    ...
                    ArrayList<SingleAnimationCell> aArray = game.aGrid.getAnimationCell(xx, yy);
                    boolean animated = false;
                    for (int i = aArray.size() - 1; i >= 0; i--) {
                        SingleAnimationCell aCell = aArray.get(i);
    ...
    private void drawEndGameState(Canvas canvas) {
        ...
        for (SingleAnimationCell animation : game.aGrid.globalAnimation) {
    ...
    public SingleView(Context context) {
        ...
        setOnTouchListener(new SingleInputListener(this));
        game.newGame();
    }
}
